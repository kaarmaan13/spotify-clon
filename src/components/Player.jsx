...
const VolumeControl = () => {
  ...
  return (
    <div className="flex flex-1 justify-end items-center gap-x-3 text-white">
...
export function Player() {
  ...
  return (
    <div className="flex justify-between w-full z-50">
      ...
      <div className="grid place-content-center gap-4 flex-1 w-1/3">
      ...
      <div className="place-content-end flex flex-1">
        <VolumeControl />
      </div>
    </div>
  )
